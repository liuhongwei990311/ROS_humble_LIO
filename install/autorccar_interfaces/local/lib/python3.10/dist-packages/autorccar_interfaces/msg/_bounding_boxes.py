    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autorccar_interfaces.msg.BoundingBoxes')
            logger.debug(
...
class BoundingBoxes(metaclass=Metaclass_BoundingBoxes):
    ...
    _fields_and_field_types = {
        'num': 'int64',
        'bounding_boxes': 'sequence<vision_msgs/BoundingBox2D>',
    }
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'bounding_boxes' field must be a set or sequence and each value of type 'BoundingBox2D'"
