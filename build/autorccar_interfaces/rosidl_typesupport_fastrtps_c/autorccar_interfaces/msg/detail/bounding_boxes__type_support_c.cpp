...
#include "autorccar_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_c.h"
...
#include "vision_msgs/msg/detail/bounding_box2_d__functions.h"  // bounding_boxes

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_autorccar_interfaces
...
using _BoundingBoxes__ros_msg_type = autorccar_interfaces__msg__BoundingBoxes;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    if (ros_message->bounding_boxes.data) {
      vision_msgs__msg__BoundingBox2D__Sequence__fini(&ros_message->bounding_boxes);
    }
    if (!vision_msgs__msg__BoundingBox2D__Sequence__init(&ros_message->bounding_boxes, size)) {
...
size_t get_serialized_size_autorccar_interfaces__msg__BoundingBoxes(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoundingBoxes__ros_msg_type * ros_message = static_cast<const _BoundingBoxes__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoundingBoxes__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autorccar_interfaces__msg__BoundingBoxes(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autorccar_interfaces
size_t max_serialized_size_autorccar_interfaces__msg__BoundingBoxes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces__msg__BoundingBoxes;
    is_plain =
      (
...
static size_t _BoundingBoxes__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autorccar_interfaces__msg__BoundingBoxes(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autorccar_interfaces, msg, BoundingBoxes)() {
