...
#include "autorccar_interfaces/msg/detail/path_point__rosidl_typesupport_fastrtps_c.h"
...
using _PathPoint__ros_msg_type = autorccar_interfaces__msg__PathPoint;
...
static uint32_t _PathPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autorccar_interfaces__msg__PathPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces__msg__PathPoint;
    is_plain =
      (
...
static size_t _PathPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autorccar_interfaces__msg__PathPoint(
