...
#include "autorccar_interfaces/msg/detail/gnss__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // position_ecef, velocity_ecef
...
using _Gnss__ros_msg_type = autorccar_interfaces__msg__Gnss;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: position_ecef
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->position_ecef, cdr))
    {
      return false;
    }
  }

  // Field name: velocity_ecef
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
...
size_t get_serialized_size_autorccar_interfaces__msg__Gnss(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gnss__ros_msg_type * ros_message = static_cast<const _Gnss__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Gnss__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autorccar_interfaces__msg__Gnss(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autorccar_interfaces
size_t max_serialized_size_autorccar_interfaces__msg__Gnss(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces__msg__Gnss;
    is_plain =
      (
...
static size_t _Gnss__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autorccar_interfaces__msg__Gnss(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autorccar_interfaces, msg, Gnss)() {
