...
static const _Gnss_type_support_symbol_names_t _Gnss_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autorccar_interfaces, msg, Gnss)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autorccar_interfaces, msg, Gnss)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autorccar_interfaces, msg, Gnss)() {
  return &::autorccar_interfaces::msg::rosidl_typesupport_c::Gnss_message_type_support_handle;
}
