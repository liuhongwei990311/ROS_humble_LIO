...
static const _ControlCommand_type_support_symbol_names_t _ControlCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autorccar_interfaces, msg, ControlCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autorccar_interfaces, msg, ControlCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, autorccar_interfaces, msg, ControlCommand)() {
  return &::autorccar_interfaces::msg::rosidl_typesupport_c::ControlCommand_message_type_support_handle;
}
