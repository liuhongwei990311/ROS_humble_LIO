...
class Metaclass_Path(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from autorccar_interfaces.msg import PathPoint
...
class Path(metaclass=Metaclass_Path):
    ...
    _fields_and_field_types = {
        'path_points': 'sequence<autorccar_interfaces/PathPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autorccar_interfaces', 'msg'], 'PathPoint')),  # noqa: E501
    )
