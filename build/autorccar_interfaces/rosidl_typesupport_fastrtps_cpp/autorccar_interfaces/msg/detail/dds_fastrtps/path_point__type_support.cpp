...
#include "autorccar_interfaces/msg/detail/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autorccar_interfaces::msg::PathPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autorccar_interfaces::msg::PathPoint & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces::msg::PathPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autorccar_interfaces::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autorccar_interfaces::msg::PathPoint *>(
    untyped_ros_message);
...
{
  return &autorccar_interfaces::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autorccar_interfaces, msg, PathPoint)() {
  return &autorccar_interfaces::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
