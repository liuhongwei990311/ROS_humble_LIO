...
#include "autorccar_interfaces/msg/detail/bounding_boxes__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autorccar_interfaces::msg::BoundingBoxes & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autorccar_interfaces::msg::BoundingBoxes & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces::msg::BoundingBoxes;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autorccar_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autorccar_interfaces::msg::BoundingBoxes *>(
    untyped_ros_message);
...
get_message_type_support_handle<autorccar_interfaces::msg::BoundingBoxes>()
{
  return &autorccar_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autorccar_interfaces, msg, BoundingBoxes)() {
  return &autorccar_interfaces::msg::typesupport_fastrtps_cpp::_BoundingBoxes__handle;
}
