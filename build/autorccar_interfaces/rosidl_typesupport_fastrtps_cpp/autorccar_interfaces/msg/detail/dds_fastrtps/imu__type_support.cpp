...
#include "autorccar_interfaces/msg/detail/imu__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autorccar_interfaces::msg::Imu;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autorccar_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autorccar_interfaces::msg::Imu *>(
    untyped_ros_message);
...
{
  return &autorccar_interfaces::msg::typesupport_fastrtps_cpp::_Imu__handle;
}
