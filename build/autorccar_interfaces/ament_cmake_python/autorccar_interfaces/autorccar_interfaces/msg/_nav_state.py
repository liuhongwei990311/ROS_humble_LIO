...
class Metaclass_NavState(type):
    """Metaclass of message 'NavState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autorccar_interfaces.msg.NavState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__nav_state
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__nav_state
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__nav_state
            cls._TYPE_SUPPORT = module.type_support_msg__msg__nav_state
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__nav_state
...
class NavState(metaclass=Metaclass_NavState):
    """Message class 'NavState'."""
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Vector3
        self.origin = kwargs.get('origin', Vector3())
        from geometry_msgs.msg import Vector3
    ...
    def origin(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'origin' field must be a sub message of type 'Vector3'"
        self._origin = value
