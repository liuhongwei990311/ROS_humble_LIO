...
bool autorccar_interfaces__msg__bounding_boxes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autorccar_interfaces.msg._bounding_boxes.BoundingBoxes", full_classname_dest, 54) == 0);
  }
  autorccar_interfaces__msg__BoundingBoxes * ros_message = _ros_message;
  {  // num
  ...
  {  // bounding_boxes
    ...
    vision_msgs__msg__BoundingBox2D * dest = ros_message->bounding_boxes.data;
...
PyObject * autorccar_interfaces__msg__bounding_boxes__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autorccar_interfaces.msg._bounding_boxes");
