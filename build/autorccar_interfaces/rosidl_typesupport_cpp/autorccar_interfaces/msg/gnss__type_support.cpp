...
static const _Gnss_type_support_symbol_names_t _Gnss_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autorccar_interfaces, msg, Gnss)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autorccar_interfaces, msg, Gnss)),
  }
};
...
{
  return &::autorccar_interfaces::msg::rosidl_typesupport_cpp::Gnss_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autorccar_interfaces, msg, Gnss)() {
  return get_message_type_support_handle<autorccar_interfaces::msg::Gnss>();
}
